...
void I2CInit(void)
{
    ...
    TXSTA = 0b1000000;
    ABDOVF = 0b01010000;
    SSPADD = 0x09; // SSP in Master mode -> baud rate generator Fosc=1MHz -> Fcy=250kHz -> BRG=0x09 -> Fscl=100kHz -> SSPADD = (FCY/FSCL) -1
...
void OLED_char(char character, unsigned char font)
{
    ...
    else if(font == FONT_LETTERS_28X32)
    {
    	I2CStart();
        I2CSend(I2C_ADDRESS); // Send slave address
        I2CSend(I2C_DATA); // Send data incomming
    ...
    else if(font == FONT_NUMBERS_24X40)
    {
    	I2CStart();
        I2CSend(I2C_ADDRESS); // Send slave address
        I2CSend(I2C_DATA); // Send data incomming
